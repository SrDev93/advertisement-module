            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h3 class="card-title">افزودن ویژگی</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('AdverProperty.store') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="type" id="type" class="form-control" required>
                                    <option value="text" @if(old('type') == 'text') selected @endif>متن</option>
                                    <option value="boolean" @if(old('type') == 'boolean') selected @endif>چک باکس</option>
                                </select>
