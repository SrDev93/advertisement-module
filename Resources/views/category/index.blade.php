...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('AdverCategory.create') }}" class="btn btn-primary">افزودن دسته بندی</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
{{--        <script type="text/javascript" src="{{ my_asset('assets/admin/js/easing.min.js') }}"></script>--}}
        <script type="text/javascript" src="{{ my_asset('assets/admin/js/nestable.min.js') }}"></script>
        <script type="text/javascript">
            $('.dd').nestable();
            $('.dd').on('change', function () {
                $.post('{{ route('AdverCategory-sort') }}', {
